...
const ReportedPromptPage = async () => {
    ...
    return (
        <div className="p-6 bg-white min-h-screen">
            <div className="mb-6">
                <h1 className="text-xl font-bold text-zinc-900">Reported Resources</h1>
                <p className="text-sm text-zinc-500">Manage and review all resources reported by users.</p>
            </div>
